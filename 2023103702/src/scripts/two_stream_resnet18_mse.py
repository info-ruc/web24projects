...
# torch.save(train_loss_list_toTensor,"./CEKappaLoss/twostreamResnet18_train_MSELoss")
# torch.save(val_loss_list_toTensor,"./CEKappaLoss/twostreamResnet18_val_MSELoss")
torch.save(model1.state_dict(),'F:/PostGraduate/TaskOne/epoch20_parameters_model1_twostreamResnet18_MSELoss.pkl')
torch.save(model2.state_dict(),'F:/PostGraduate/TaskOne/epoch20_parameters_model2_twostreamResnet18_MSELoss.pkl')
torch.save(model3.state_dict(),'F:/PostGraduate/TaskOne/epoch20_parameters_model3_twostreamResnet18_MSELoss.pkl')