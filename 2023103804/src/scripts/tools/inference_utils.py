...
def inference_intermediate_fusion(batch_data, model, dataset,i):
    ...
    gt_box_tensor : torch.Tensor
        The tensor of gt bounding box.
    """
    return_dict = inference_early_fusion(batch_data, model, dataset,i)
    # pred_box_tensor = return_dict['pred_box_tensor']
    # pred_score = return_dict['pred_score']
    # gt_box_tensor = return_dict['gt_box_tensor']
