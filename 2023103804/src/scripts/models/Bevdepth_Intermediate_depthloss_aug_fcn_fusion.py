...
from .sub_modules.homography import clsdepthfusion
...
class BevdepthIntermediatedepthlossaugfcnfusion(LiftSplatShoot):
    def __init__(self, args):
        super(BevdepthIntermediatedepthlossaugfcnfusion, self).__init__(args)
        ...
        self.clsdepthfusion = clsdepthfusion()
        self.fcn = FCN8s(2)
    ...
    def depthforward(self,x,rots,trans,intrins,post_rots,post_trans,transform_matrix,lidar_depth,depth_downsample):
        ...
        attention_mask_non_car = attention_mask_non_car.unsqueeze(1)
        ...
        return x, depth_logit, final_depth, get_bev_depth, cls_img_3d
    ...
    def _forward_ms(self, data_dict):
        ...
        bev_map = self.clsdepthfusion(bev_map,record_len,pairwise_t_matrix,get_bev_depth,cls_img)
...
def compile_model(grid_conf, data_aug_conf, outC):
    return BevdepthIntermediatedepthlossaugfcnfusion(grid_conf, data_aug_conf, outC)