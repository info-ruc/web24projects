...
class LiftSplatShoot(nn.Module):
    def __init__(self, args): 
        ...
        self.discrete_ratio = args['fusion_args']['args']['voxel_size'][0]
    ...
    def create_frustum(self):
        ...
        fH, fW = ogfH // self.downsample, ogfW // self.downsample  # 下采样16倍后图像大小  fH: 40  fW: 60
    ...
    def voxel_pooling(self, geom_feats, x):
        # geom_feats: B x N x D x H x W x 3 (4 x 6 x 48 x 44 x 22 x 3), D is discretization in "UD" or "LID"
    ...
    #     n_agent,n_cam,H,W = lidar_depth.shape
    #     lidar_depth.view(
    #         n_cam*n_agent,
    #         H // self.downsample,
    #         self.downsample,
    ...
    #     lidar_depth = lidar_depth.view(n_agent, n_cam, 1,
    #                                    H // self.downsample,
    #                                    W // self.downsample)
    ...
    def forward(self, data_dict):
        ...
        # post_rots: [4,4,3,3]
        # post_trans: [4,4,3]
        # lidar_depth: [N,4,320,480]
        if 'lidar_depth' not in data_dict:
            pass
        else:
            lidar_depth = data_dict['lidar_depth']
        x, rots, trans, intrins, post_rots, post_trans = \
            (data_dict['imgs'], data_dict['rots'], data_dict['trans'], data_dict['intrins'],
             data_dict['post_rots'], data_dict['post_trans'])
        # num_agent, num_cams, num_channels, img_height,img_width = x.shape
