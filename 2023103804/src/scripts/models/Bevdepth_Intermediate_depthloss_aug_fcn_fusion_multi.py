...
class BevdepthIntermediatedepthlossaugfcnfusionmulti(LiftSplatShoot):
    def __init__(self, args):
        super(BevdepthIntermediatedepthlossaugfcnfusionmulti, self).__init__(args)
    ...
    def depthforward(self,x,rots,trans,intrins,post_rots,post_trans,transform_matrix,lidar_depth,depth_downsample):
        ...
        # For simple addition:
        final_depth = depth_map_car + depth
...
def compile_model(grid_conf, data_aug_conf, outC):
    return BevdepthIntermediatedepthlossaugfcnfusionmulti(grid_conf, data_aug_conf, outC)