...
See the examples notebooks on [using SAM with prompts](/opencood/data_utils/notebooksdata_utils/notebooks/predictor_example.ipynb) and [automatically generating masks](/opencood/data_utils/notebooksdata_utils/notebooks/automatic_mask_generator_example.ipynb) for more details.
