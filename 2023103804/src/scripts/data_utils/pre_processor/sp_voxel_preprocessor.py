...
class SpVoxelPreprocessor(BasePreprocessor):
    ...
    def preprocess(self, pcd_np):
        ...
        # voxel_output = self.voxel_generator.generate_voxel_with_id(pcd_np)
        # spconv has been to tensor as input
        voxel_output = self.voxel_generator(torch.from_numpy(pcd_np))
