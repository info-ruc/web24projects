...
train_file = [
    f"{anno_root_downstream}/reversed_in_time/shuffle/train_reverse_rewrite_shuffle.json",
    "/data2/dy/temporal_video/dataset",
    "video",
]
test_file = dict(
    test=[
        f"{anno_root_downstream}/reversed_in_time/test2k.json",
         "/data2/dy/temporal_video/dataset",
        "video",
    ],
)
...
# ========================= input ==========================
num_frames = 12
num_frames_test = 12 # 选checkpoint的时候用的是这个，和上边的不一样会报错。
batch_size = 32
max_txt_l = 32
evaluate = False
