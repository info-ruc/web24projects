...
save_latest = True
auto_resume = True
pretrained_path = "/data2/lyq/code/clip_pretrain/ckpts/ckpt_pretrain_logsoftmax_tempsimsiam_0.1/pytorch_model.bin.2"  # path to pretrained model weights, for resume only?
