...
# train_file = [
#     f"/data2/dy/temporal_video/dataset/without_webvid_annotations/VLM_split/allreverse_rewrite.json",
#     "/data2/dy/temporal_video/dataset",
#     "video",
# ]
train_file = [
    f"/datassd1/WebVid/webvid_temporal_2M.json",
    "/datassd1/WebVid/videos",
    "video",
]
test_file = dict(
    test=[
        f"/data2/dy/code/unmasked_teacher/umt_data/anno_downstream/reversed_in_time/test2k.json",
         "/data2/dy/temporal_video/dataset",
        "video",
    ],
)
...
# ========================= input ==========================
num_frames = 4
num_frames_test = 4 # 选checkpoint的时候用的是这个，和上边的不一样会报错。
batch_size = 32
max_txt_l = 50
...
# train_file = [
#     f"{anno_root_downstream}/reversed_in_time/training_200k.json",
#     "/data2/dy/temporal_video/dataset",
#     "video",
# ]
# test_file = dict(
#     test=[
#         f"/data2/dy/temporal_video/dataset/without_webvid_annotations/test_reverse.json",
#          "/data2/dy/temporal_video/dataset",
#         "video",
#     ],
# )
